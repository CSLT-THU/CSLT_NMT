...
class GRUCell(RNNCell):
    ...
    def __init__(self, num_units, input_size=None, activation=tanh):
        ...
        self._num_units = num_units
        self._activation = activation
        self._weight_initializer = orthogonal_initializer()
        ...
        with vs.variable_scope(scope or type(self).__name__):  # "GRUCell"
            ...
            with vs.variable_scope("Candidate"):
                c = self._activation(_linear2([inputs, r * state],
                                              self._num_units, False, weight_initializer=self._weight_initializer))
            new_h = u * state + (1 - u) * c
        return new_h, new_h
...
class EmbeddingWrapper(RNNCell):
    ...
    def __init__(self, cell, embedding_classes, embedding_size, embedding=None, initializer=None):
        ...
        Args:
          ...
          embedding: an externally defined word embedding
...
def _linear2(args, output_size, bias, bias_start=0.0, weight_initializer=None, scope=None):
    ...
    Args:
      ...
      bias: boolean, whether to add a bias term or not.
      bias_start: starting value to initialize the bias; 0 by default.
      weight_initializer: the initializer of weight matrix
      scope: VariableScope for the created subgraph; defaults to "Linear".
